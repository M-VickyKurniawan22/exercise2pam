package com.example.exercise2pam.adapter;
import android.app.AlertDialog;
        ...
        import com.example.exercise2pam.EditTemanActivity;
        import com.example.exercise2pam.MainActivity;
        import com.example.exercise2pam.R;
        import com.example.exercise2pam.ShowTemanActivity;
...
public class TemanAdapter extends RecyclerView.Adapter<TemanAdapter.TemanViewHolder> {
    ...
    public class TemanViewHolder extends RecyclerView.ViewHolder {
        ...
        public TemanViewHolder(@NonNull View itemView) {
            super(itemView);
            cardView = itemView.findViewById(R.id.cvTeman);
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, ShowTemanActivity.class);
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                case R.id.mnEdit:
                                    ...
                                    Intent intent = new Intent(context, EditTemanActivity.class);
                                    intent.putExtras(bundle);
                                    context.startActivity(intent);
                                    break;
                                case R.id.mnDelete:
